...
<li>
    <strong>Allow Customer to change delivery Date and delivery time in placed order (Addon plugin for pro)</strong><br>
    <ul>
    <li>Registered customer will get an option to change the selected delivery date and delivery time</li>
    <li>The option to chang will be present in the My account &gt; View order detail page</li>
    <li>You can put a cutoff time limit, if the user selected time comes below that cutoff time then user will not be allowed to change the delivery date and delivery time</li>
    <li>Once delivery date and time are modified the woocommerce admin will receive an email of the change in order</li>
    </ul>
    <a href="https://www.youtube.com/watch?v=-aqUGRQYFCQ">Watch video</a>
</li>
<li>
