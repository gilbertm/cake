...
class pisol_dtt_addons{
    ...
    function tab(){
        ?>
        <a class="mr-0 ml-auto px-2 text-light d-flex align-items-center  border-left border-right text-dark <?php echo ($this->active_tab == $this->this_tab ? 'bg-warning' : 'bg-warning'); ?>" href="<?php echo admin_url( 'admin.php?page='.sanitize_text_field($_GET['page']).'&tab='.$this->this_tab ); ?>">
    ...
    <div class="border p-2 my-3">
     ...
     <li>You can use this plugin to change time slot of some normal working date as well </li>
        ...
        <div class="border p-2 my-3">
            <div class="row align-items-center">
                    <div class="col-12 col-md-5">
                        <iframe style="width:100%; height:230px;" src="https://www.youtube.com/embed/-aqUGRQYFCQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <div class="col-12 col-md-7">
                        <h3>Allow Customer to change Date and time in placed order (Addon plugin)</h3>
                        <ul>
<li>Registered customer will get an option to change the selected date and time</li>
<li>The option to chang will be present in the My account &gt; View order detail page</li>
<li>You can put a cutoff time limit, if the user selected time comes below that cutoff time then user will not be allowed to change the date and time</li>
<li>Once date and time are modified the woocommerce admin will receive an email of the change in order</li>
</ul>
                        <div class="py-2 text-right">
                            <a class="btn btn-md btn-primary" href="https://www.piwebsolution.com/cart/?add-to-cart=12079&variation_id=12084" target="_blank">Buy Now</a> 
                        </div>
                    </div>
            </div>
        </div>
