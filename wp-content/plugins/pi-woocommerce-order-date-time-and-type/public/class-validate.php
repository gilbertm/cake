...
class pi_dtt_validate{
    ...
    function validateCheckout($data, $errors){
        ...
        $date = isset($_POST['pi_system_delivery_date']) ? $_POST['pi_system_delivery_date'] : "";
        $time = isset($_POST['pi_delivery_time']) ? $_POST['pi_delivery_time'] : "";

        if(pi_dtt_display_fields::showDateAndTime()):
            if(pi_dtt_display_fields::isDateRequired()){     
                if (!isset($_POST['pi_system_delivery_date']) || empty( $_POST['pi_system_delivery_date'])){
            ...
            if(pi_dtt_display_fields::enableTimeField() && pi_dtt_display_fields::isTimeRequired()){    
                if (!isset($_POST['pi_delivery_time']) || empty($_POST['pi_delivery_time'])){
        ...
        $location_id = isset($_POST['pickup_location']) ? (int)$_POST['pickup_location'] : "";
