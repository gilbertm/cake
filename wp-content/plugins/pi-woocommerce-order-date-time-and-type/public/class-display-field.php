...
class pi_dtt_display_fields{
    ...
    function dateField(){
        ...
        echo '<input type="hidden" name="pi_system_delivery_date" id="pi_system_delivery_date">';
    }
    ...
    function pickupLocationFields($delivery_type = ""){
        ...
        if(!empty($address1)){
            echo '<div class="pisol-pickup-add"><input type="radio" name="pickup_location" class="pisol-location-radio" value="pi_pickup_address_1" id="pi_pickup_address_1" checked="checked"><label class="pisol-location" for="pi_pickup_address_1">'.$address1.'</label></div>';
        }
        if(!empty($address2)){
            echo '<div class="pisol-pickup-add"><input type="radio" name="pickup_location" class="pisol-location-radio" value="pi_pickup_address_2" id="pi_pickup_address_2"><label  class="pisol-location" for="pi_pickup_address_2">'.$address2.'</label></div>';
        }
        echo '</div>';
        echo '</div>';
    }
    ...
    static function showDateAndTime($type = ""){
        ...
        $show_date_time = pisol_dtt_get_setting('pi_datetime', '1');
