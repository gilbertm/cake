	...
	class CR_Shortcodes_Settings {
		...
		*/
		...
		public function show_shortcodes( $value ) {
			...
			'<li>' . sprintf( __( '%1s argument defines how many reviews will be shown at once. This argument is ignored when %2s argument is greater than %3s.', 'customer-reviews-woocommerce' ), '<code>per_page</code>', '<code>show_more</code>', '<code>0</code>' ) . '</li>' .
