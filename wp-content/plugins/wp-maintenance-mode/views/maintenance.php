...
<html>
	<head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="https://sunshinessweettooth.com/wp-content/uploads/2022/02/favicon.png">
...
<link href="https://fonts.googleapis.com/css2?family=Yellowtail&display=swap" rel="stylesheet">
	...
	<section class="header position-fixed w-100" style="z-index:1">
		<div class="row p-3">
			<div class="col" style="display: flex;align-items: center;flex-wrap: wrap;"><img src="https://sunshinessweettooth.com/wp-content/uploads/2022/02/logo.png" alt="" style="max-height:125px" /> <a href="https://m.facebook.com/pg/sweettoothbysunshine/reviews/?ref=bookmarks&mt_nav=0" target="_blank"><img src="https://sunshinessweettooth.com/wp-content/uploads/2022/02/facebook.png" alt="" style="padding:10px; max-height:75px" /></a> </div>
		</div>
	</section>
        ...
        <div class="col-12">
          <div class="card---hero-banner card m-0 p-0 border-0 bg-transparent">
            <div class="d-none d-md-block">
              <img src="https://sunshinessweettooth.com/wp-content/uploads/2022/01/cake-1920x1080-1.jpg" alt="" />
            </div>
            <div class="d-md-none">
              <div class="field-primary-hero-image-mobile">
                <img src="https://sunshinessweettooth.com/wp-content/uploads/2022/02/brochure-768x768-1.jpg" alt="" />
              </div>
            </div>
