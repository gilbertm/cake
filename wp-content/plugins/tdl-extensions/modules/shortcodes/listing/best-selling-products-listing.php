...
// [best_selling_products_listing]
function shortcode_best_selling_products_listing($atts, $content = null) {
	$randomid = rand();
...
add_shortcode("best_selling_products_listing", "shortcode_best_selling_products_listing");