...
vc_map(array(
   "name"			=> esc_html__('Add to Cart Button', 'eva'),
   ...
   "params" 	=> array(
		...
		array(
			...
			"class" 		=> "hide_in_vc_editor",
			"admin_label" 	=> true,
			"heading"		=> esc_html__('Show Price', 'eva'),
		...
		array(
			...
			"class" 		=> "hide_in_vc_editor",
			"admin_label" 	=> true,
			"heading"		=> esc_html__('Price Color', 'eva'),
		...
		array(
			...
			"class" 		=> "hide_in_vc_editor",
			"admin_label" 	=> true,
			"heading"		=> esc_html__('Text Color', 'eva'),
		...
		array(
			...
			"class" 		=> "hide_in_vc_editor",
			"admin_label" 	=> true,
			"heading"		=> esc_html__('Background Color', 'eva'),
			"param_name"	=> "bg_color",
			"value"			=> "",
		),
   )
