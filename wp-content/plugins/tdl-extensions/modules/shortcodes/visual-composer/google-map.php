...
vc_map(array(
   ...
   "params" 	=> array(
		    ...
		    array(
		      ...
		      "description" => __("Zoom level when focus the marker. 1-20", "js_composer"),
		      "param_name" => "zoom",
		      "class" 		=> "hide_in_vc_editor",
		      "admin_label" 	=> true,
		      'save_always' => true,
		    ...
		    array(
			  ...
			  'save_always' => true,
			  "description" => __("Please select the marker style you would like <br/> <b>Default Google Style</b> <i> - Will display the Google standard map marker and also allow you to optionally override it with an image</i> <br/> <b>Eva Animated</b> <i>- Will use a custom Eva CSS based marker (the modern option).</i> ", "js_composer")
			),	
		 ...
		 //    array(
			...
			// 	"param_name" => "eva_marker_color",
			// 	"admin_label" 	=> true,
			// 	"class" 		=> "hide_in_vc_editor",
			// 	"value" => "#a8e8e2",
			// 	"dependency" => Array('element' => "marker_style", 'value' => 'eva'),
			// 	"description" => "Please select the color for your eva marker."
			// ),							    
