...
function shortcode_custom_add_to_cart($atts, $content = null) {
	...
	?> 
	<style>
	.add_to_cart_inline .button-loader.loader-<?php echo $loaderrandomid; ?> {
		border-radius: 70% !important;
  		border: 2px solid transparent !important;
  		border-bottom-color: <?php echo $text_color; ?> !important;		
	}
    ...
    <p class="product woocommerce add_to_cart_inline price-field-<?php echo $loaderrandomid ?>" style="text-align:<?php echo $align; ?>">
