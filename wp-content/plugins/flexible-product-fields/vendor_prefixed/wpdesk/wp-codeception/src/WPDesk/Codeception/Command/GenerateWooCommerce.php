 ...
 */
class GenerateWooCommerce extends \VendorFPF\Codeception\Command\GenerateTest implements \VendorFPF\Codeception\CustomCommandInterface
{
    /**
    ...
    {
        return new \VendorFPF\WPDesk\Codeception\Command\WooCommerceTestGenerator($config, $class);
    }
    /**
     * Execute command.
     *
