 ...
 */
     ...
     * @return string
     */
    function eva_product_attributes() {
        $output = array();
        if ( function_exists( 'wc_get_attribute_taxonomies' ) ) {
            $attributes_tax = wc_get_attribute_taxonomies();
            if ( $attributes_tax ) {
                $output['none'] = esc_html__( 'None', 'eva' );
...
/* ---------------------------------------------------------------- */
    ...
    Redux::setSection( $opt_name, array(
                ...
                array(
                 ...
                 array(
                    'title' => esc_html__('Enable Back to Top button', 'eva'),
                     // 'subtitle' => esc_html__('Show social icons in Off-canvas navigation menu', 'eva'),
                    'id' => 'tdl_backtotop',
                    'on' => esc_html__('Enabled', 'eva'),
                    'off' => esc_html__('Disabled', 'eva'),
    ...
    Redux::setSection( $opt_name, array(
            ...
            'fields'    => array(
                ...
                array(
                 ...
                 array(
                    'title' => esc_html__('Header Contact Section in mobile off-canvas menu', 'eva'),
                    'subtitle' => esc_html__('Show Contact section in mobile off-canvas menu', 'eva'),
                    'id' => 'tdl_contact_mobile',
                    'on' => esc_html__('Enabled', 'eva'),
                    'off' => esc_html__('Disabled', 'eva'),
                ...
                array(
                    ...
                    'subtitle' => esc_html__('Show contact icon in the Contact section', 'eva'),
                    'id' => 'tdl_contact_icon',
                    'on' => esc_html__('Enabled', 'eva'),
                    'off' => esc_html__('Disabled', 'eva'),
                    // 'required' => array( 'tdl_contact_bar', 'equals', array( '1' ) ),
                    // 'required' => array( 
                    //     array('tdl_contact_bar','equals','1'), 
                    //     array('tdl_contact_mobile','equals','1') 
                    // ),                   
                    'type' => 'switch',
                    'default' => 0,
                ), 
...
/* ---------------------------------------------------------------- */
    ...
    Redux::setSection( $opt_name, array(
            ...
            'fields'    => array(
                ...
                array(
                    'desc' => esc_html__('As of WP 4.3, the favicon setting is now available in the default WordPress customizer (Appearance > Customize > Site Identity).', 'eva'),
                    'id' => 'info_success',
                    'type' => 'info',
                    'style' => 'success',
...
/* ---------------------------------------------------------------- */
    ...
    Redux::setSection( $opt_name, array(
            ...
            'icon'  => 'fa fa-shopping-cart',
                ...
                array(
                    'id' => 'tdl_catalog_mode_price',
                    'type' => 'switch',
                    'on' => esc_html__('Enable', 'eva'),
                    'off' => esc_html__('Disable', 'eva'),
                    'title' => 'Remove Product Price',
                    'default'  => 0,
                    'required' => array( 'tdl_catalog_mode', 'equals', array( '1' ) )
                ), 
...
/* ---------------------------------------------------------------- */
    ...
    Redux::setSection( $opt_name, array(
                ...
                //     'on' => esc_html__('Enabled', 'eva'),
                //     'off' => esc_html__('Disabled', 'eva'),
                //     'title' => esc_html__( 'Ajax For Filtering', 'eva' ),
                //     'subtitle' => esc_html__( 'Check this option to use ajax for filtering in the catalog page.', 'eva' ),
                //     'default' => 1,
                // ),                     
                ...
                array(
                    'title' => esc_html__('Categories in page heading', 'eva'),
                    'subtitle' => esc_html__('This categories menu is generated automatically based on all categories in the shop. You are not able to manage this menu as other WordPress menus', 'eva'),
                ...
                array(
                    'title' => esc_html__('Products per page', 'eva'),
                    'subtitle' => esc_html__('Number of products per page', 'eva'),
                ...
                array(
                    ...
                    'subtitle' => esc_html__('For ex.: 12,24,36,-1. Use -1 to show all products on the page', 'eva'),
                    'default' => '12,24,36',
                ...
                array(
                    'id'       => 'tdl_shop_categories_mob',
                    'type'     => 'button_set',
                    'title'    => __('Number of Categories per Column on mobile', 'eva'), 
                    'options'  => array(
                        'cat_one_col' => __('1 per column', 'eva'), 
                        'cat_two_col' => __('2 per column', 'eva'),  
                    ),
                    'default' => 'cat_two_col'
                ),                
                ...
                array(
                    'subtitle' => __('Show product attribute for each item listed under the item name.', 'eva'),
                    'id' => 'tdl_product_attribute',
                    'type' => 'select',
                    'title' => __('Product Attribute', 'eva'), 
                    'options'   => eva_product_attributes(),
                    'default' => 'none',
                ...
                // array(
                //     'id' => 'shop_swatches_info',
                //     'icon' => true,
                //     'type' => 'info',
                //     'raw' => esc_html__('Attribute swatches', 'eva'),
                // ),     

                // array(
                //     'id'       => 'tdl_grid_swatches_attr',
                //     'type'     => 'select',
                //     'title'    => esc_html__('Grid swatch attribute to display', 'eva'),
                //     'subtitle' => esc_html__('Choose attribute that will be shown on products grid', 'eva'),
                //     'data'  => 'taxonomy',
                // ), 

                // array(
                //     'id'       => 'tdl_swatches_variation_images',
                //     'type'     => 'switch',
                //     'title'    => esc_html__('Use images from product variations', 'eva'),
                //     'subtitle' => esc_html__('If enabled swatches buttons will be filled with images choosed for product variations and not with images uploaded to attribute terms.', 'eva'),
                //     'on' => esc_html__('Enabled', 'eva'),
                //     'off' => esc_html__('Disabled', 'eva'),                   
                //     'default' => false
                // ),
    ...
    Redux::setSection( $opt_name, array(
                ...
                'fields'    => array(
                 ...
                 array(
                    ...
                    'type'     => 'image_select',
                    'compiler' => true,
                    'title'    => esc_html__( 'Product page design', 'eva' ),
                    'subtitle' => esc_html__( 'Choose between different predefined designs', 'eva' ),
                    'options'  => array(
                        'default' => array(
                            'alt' => 'Layout 1',
                            'img' => get_template_directory_uri() . '/images/theme-options/product_layout_1.png'
                        ),
                        'images_scroll' => array(
                            'alt' => 'Layout 2',
                            'img' => get_template_directory_uri() . '/images/theme-options/product_layout_2.png'
                        ),                      
                    ),
                    'default'  => 'default'
                ), 
                ...
                array(
                    'title' => esc_html__('Product Gallery Lightbox Dominant Background', 'eva'),
                    'subtitle' => esc_html__('Enable / Disable dominant background color on Product Gallery Lightbox.', 'eva'),
                    'id' => 'tdl_product_gallery_dominant',
                    'on' => esc_html__('Enabled', 'eva'),
                    'off' => esc_html__('Disabled', 'eva'),
                    'type' => 'switch',
                    'default' => 1,
                    'required' => array( 'tdl_product_gallery_lightbox', 'equals', array( '1' ) )
                ),                                
                ...
                array(
                    'title' => esc_html__('Size guides', 'eva'),
                    'subtitle' => __('Turn on the size guide feature on the website. Read more information about this function in <a href="https://temashdesign.ticksy.com/article/15532/" target="_blank">our documentation</a>.', 'eva'),
                    'id' => 'tdl_size_chart',
                    'on' => esc_html__('Enabled', 'eva'),
                    'off' => esc_html__('Disabled', 'eva'),
                    'type' => 'switch',
                ...
                array(
                    'title' => esc_html__('Size Guide Title', 'eva'),
                    'subtitle' => esc_html__('Type your Size Guide Title', 'eva'),
                ...
                'fields'    => array(
                    ...
                    array (
                       ...
                       array (
                        ...
                        array (
                            'title' => __('<i class="fa fa-telegram"></i> Telegram', 'eva'),
                            'subtitle' => esc_html__('Type your Telegram profile URL here.', 'eva'),
                            'id' => 'telegram_link',
                            'type' => 'text',
                        ), 

                        array (
                            'title' => __('<i class="fa fa-whatsapp"></i> WhatsApp', 'eva'),
                            'subtitle' => esc_html__('Type your WhatsApp profile URL here.', 'eva'),
                            'id' => 'whatsapp_link',
                            'type' => 'text',
                        ),                                              
    ...
    Redux::setSection( $opt_name, array(
            ...
            'fields'    => array(
                ...
                array(
                    ...
                    'subtitle' => __('Please make sure you have "Smash Balloon Instagram Feed" plugin installed.', 'eva'),
                ...
                array(
                    'title' => esc_html__('Show Profile Link', 'eva'),
                    'subtitle' => esc_html__('Show a link to the Instagram profile page.', 'eva'),
                    'id' => 'tdl_instagram_profile',
                    'on' => esc_html__('Enabled', 'eva'),
                    'off' => esc_html__('Disabled', 'eva'),
                    'type' => 'switch',
                    'default' => 1,
                ...
                array(
                    ...
                    'required' => array( 
                        array('tdl_instagram_feed','equals','1'), 
                        array('tdl_instagram_profile','equals','1') 
                    ), 
                    'default' => 'instagram',                   
                ), 
                ...
                array(
                    ...
                    'default' => '&copy; 2021 - Eva Woocommerce Theme. Created by <a href=\'https://temash.design\'>TemashDesign</a>',
                ),
