    ...
    <form class="cart" method="post" enctype='multipart/form-data'>
        ...
        if ( $bundled_items ) {
            ...
            foreach ( $bundled_items as $bundled_item ) {
                ...
                ?>
                <tr>
                    <td class="yith-wcpb-product-bundled-item-image"> <?php echo wp_kses_post($bundled_product->get_image()); ?></td>
                    <td class="yith-wcpb-product-bundled-item-data">
                        <h3><a href="<?php echo wp_kses_post($bundled_product->get_permalink()); ?>">
                                <?php echo esc_attr($quantity) . ' x ' . $bundled_product->get_title() ?>
                            </a>
                        </h3>
                        <p><?php echo esc_attr($bundled_post->post_excerpt); ?></p>
        ...
        <button type="submit" class="single_add_to_cart_button button btn1 bshadow alt"><span><?php echo esc_attr($product->single_add_to_cart_text()); ?><i class="button-loader"></i></span></button>
