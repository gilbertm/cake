                            ...
                            <div class="product-thumbnail-inner">
                                <?php if( $show_remove_product ): ?>
                                    <div class="product-remove">
                                            <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ) ?>" class="remove_from_wishlist" title="<?php echo apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'yith-woocommerce-wishlist' ) ); ?>">×</a>
                                    </div>
                                <?php endif; ?>
                                ...
                                <table class="additional-info">
                                    ...
                                    <?php if( $show_stock_status ) : ?>
                                        <tr>
                                            ...
                                            <td class="value">
                                                <?php echo esc_attr($stock_status) == 'out-of-stock' ? '<span class="wishlist-out-of-stock">' . __( 'Out of stock', 'yith-woocommerce-wishlist' ) . '</span>' : '<span class="wishlist-in-stock">' . __( 'In Stock', 'yith-woocommerce-wishlist' ) . '</span>'; ?>
                                            </td>
                                        </tr>
                                    <?php endif ?>
                                </table>
