	...
	<tbody>
		...
		<tr>
			<td colspan="6" class="actions">
				...
				<button type="submit" class="button btn2 update_cart_button" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
