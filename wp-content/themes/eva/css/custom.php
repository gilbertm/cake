...
if (has_post_thumbnail($page_id) || $page_header_height) {
...
/***************************************************************/
    ...
    <?php if ( esc_html($page_header_height) ) : ?>
      .page-header {
        min-height: <?php echo esc_html($page_header_height); ?>px;
        margin-bottom: <?php echo esc_html($page_header_mbottom); ?>px;
      }

    @media screen and (min-width: 40em) and (max-width: 63.9375em) {
      .page-header {
        min-height: <?php echo esc_html($page_header_height) * ( 100 - 10 ) / 100; ?>px;
      }  
    }
    @media screen and (max-width: 39.9375em) {
      .page-header {
        min-height: <?php echo esc_html($page_header_height) * ( 100 - 20 ) / 100; ?>px;
      }
    }
    <?php else: ?>
...
<?php if ( $header_transparent == "transparent-header" ) : ?>
...
.widget-area .widget:not(.widget_layered_nav) ul li > a:before  {
  background-color: <?php echo esc_html($maincolor) ?>;
}

body.single-product.is-mobile .cart .single_add_to_cart_button  {
  background-color: <?php echo esc_html($maincolor) ?> !important;
}
...
.progress-page {
  background-color: rgba(<?php echo esc_html($maincolor_rgb); ?>,.2);
}
...
.offcanvas_search .suggestion_results .guaven_woos_suggestion ul li.guaven_woos_showallli:hover {
...
.footer-instagram-section #sb_instagram #sbi_images .sbi_item .sbi_photo_wrap .sbi_link .sbi_hover_bottom .sbi_meta span {
  color: <?php echo esc_html($maincolor); ?> !important;
}

.footer-instagram-section #sb_instagram #sbi_images .sbi_item .sbi_photo_wrap .fa-clone path {
  fill:<?php echo esc_html($maincolor); ?>;
}
...
.widget-area .widget .wc-block-product-categories ul li ul.children li:before, .widget-area .widget .wc-block-product-categories ul li ul.children li:after, .widget-area .widget .wc-block-product-categories ul li ul.sub-menu li:before, .widget-area .widget .wc-block-product-categories ul li ul.sub-menu li:after, .widget-area .widget .wc-block-product-categories ul li ul.wc-block-product-categories-list--depth-1 li:before, .widget-area .widget .wc-block-product-categories ul li ul.wc-block-product-categories-list--depth-1 li:after,
...
.widget-area .widget.woocommerce.widget_layered_nav .select2-container--default .select2-selection--multiple {
  border-left-color: <?php echo esc_html($maincolor) ?> !important;
  border-right-color: <?php echo esc_html($maincolor) ?> !important;
  border-top-color: <?php echo esc_html($maincolor) ?> !important;
}

.footer-instagram-section.feed-pro #sb_instagram #sbi_images .sbi_item .sbi_photo_wrap .sbi_link a.sbi_link_area:hover:before,
.footer-instagram-section.feed-simple #sb_instagram #sbi_images .sbi_item .sbi_photo_wrap a.sbi_photo:hover:before,
...
@media screen and (max-width: 39.9375em) {
  .footer-instagram-section.feed-pro #sb_instagram #sbi_images .sbi_item .sbi_photo_wrap .sbi_link a.sbi_link_area:hover:before,
  .footer-instagram-section.feed-simple #sb_instagram #sbi_images .sbi_item .sbi_photo_wrap a.sbi_photo:hover:before {
  -webkit-box-shadow: inset 0 0 0 7px <?php echo esc_html($maincolor) ?>;
  -moz-box-shadow: inset 0 0 0 7px <?php echo esc_html($maincolor) ?>;
  box-shadow: inset 0 0 0 7px <?php echo esc_html($maincolor) ?>;  
}  
}
...
.woocommerce-cart .entry-content .woocommerce form table tbody td.product-remove .remove,
.woocommerce #content table.wishlist_table.cart a.remove,
#yith-wcwl-form .shop_table.mobile li .item-wrapper .product-thumbnail .product-remove a {
...
<?php if ( (isset($tdl_options['tdl_catalog_mode_price'])) && (trim($tdl_options['tdl_catalog_mode_price']) == "1" ) ) : ?>
